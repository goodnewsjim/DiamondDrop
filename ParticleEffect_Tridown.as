package
{
    ...
    public class ParticleEffect_Tridown extends ParticleEffect
    {
		...
		public function ParticleEffect_Tridown(bit:Bitmap,cont:Object,n:int,r1:RGB,r2:RGB,r3:RGB,r4:RGB,r5:RGB,ct:int,ot:int,x33:int,y33:int)
        {
		x3=x33;
		y3=y33;
		numcolors=n;
...
//trace("ANGLE"+angle2);
		...
		next1();
				...
				particles[maxparticles].rotation=180;
		maxparticles++;
