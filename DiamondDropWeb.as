package
{
	...
	public class DiamondDropWeb extends Sprite
	{
		...
		var mouseposx:int=0;
		var mouseposy:int=0;
		var mouseposy_bottom:int=0;
		var gesture_flipped:Boolean=false; 
		...
		const GAME_ID:String = "b10db135ef3c7fd7";
		const AD_ID:String = "b10db135ef3c7fd7";  // This is normally your GAME_ID
		
		var superstage:Stage;
		...
		public function DiamondDropWeb()
		{
		...
		public function onHover(m:MouseEvent):void{
			...
			if(gameover==false)
			{
				...
				if(mousebuttondown)
				{
					if(m.stageY>mouseposy_bottom+20)
					{	mouseposy_bottom=m.stageY;
						holdit=1;
					}
					
					if(!gesture_flipped)
						if(m.stageY<mouseposy_bottom-15)
						{
							gesture_flipped=true;
